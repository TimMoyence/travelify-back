...
VALUES
    ('Marie', 'Lefort', 'marie.lefort@example.com', '333 Rue des Arbres, Ville', 'motdepasse10', '1995-02-08 10:30:00', 'Femme', 'https://travelify.fr/static/default.webp', 'Description de Marie Lefort.'),
    ('Thomas', 'Gagnon', 'thomas.gagnon@example.com', '777 Avenue du Soleil, Ville', 'supersecret10', '1994-12-15 16:45:00', 'Homme', 'https://travelify.fr/static/default.webp', 'Description de Thomas Gagnon.');

INSERT INTO event (name, owner_id, status, description, picture, password)
VALUES
    ('Conférence Tech 2023', 1, true, 'Conférence annuelle sur la technologie', 'https://travelify.fr/static/default.webp', 'motdepasse1'),
    ('Festival de Musique', 1, true, 'Festival de musique de trois jours', 'https://travelify.fr/static/default.webp', 'motdepasse2'),
    ('Gala de Bienfaisance', 1, false, 'Gala de collecte de fonds pour une bonne cause', 'https://travelify.fr/static/default.webp', 'motdepasse3'),
    ('Lancement de Produit', 1, true, 'Événement de lancement de notre nouveau produit', 'https://travelify.fr/static/default.webp', 'motdepasse4'),
    ('Atelier Communautaire', 1, true, 'Atelier pratique pour les amateurs de bricolage', 'https://travelify.fr/static/default.webp', 'motdepasse5');
